...
def render_exportacao():
    ...
    with st.container():
        ...
        with col_dates:
            ...
            tipo_filtro = st.radio("Filtrar por:", ["Sócio", "Cliente", "Diversos"], key="exp_tipo")
        ...
        with col_select:
            ...
            if tipo_filtro == "Cliente":
                ...
                if selecionado != "Todos":
                    ...
                    selecionado_emp = None
            elif tipo_filtro in ["Sócio", "Diversos"]:
    ...
    if st.button("Buscar Dados", width="stretch"):
        ...
        if not df_resultado.empty:
            if (tipo_filtro == "Cliente" and selecionado_emp == "Todas") or (tipo_filtro in ["Sócio", "Diversos"] and selecionado == "Todas"):
